...
function copy(){return(originalFlavors)
}    
...
function getFlavorByIndex(num){
  ...
  function removeFlavorByName(name){
  x = originalFlavors.indexOf(name);
  originalFlavors.splice(x,1);
  return(originalFlavors)
    
  }
  console.log(removeFlavorByName('Maple Nut'))
